...
class UserAdmin(BaseUserAdmin):
    ...
    fieldsets = (
        ...
        ('Personal info', {'fields': ('first_name', 'last_name', 'gender', 'profile_pic', 'role', 'resume_title', 'resume_text', 'skills', 'current_city')}),
        ...
        (
            None,
            {
                ...
                'fields': (
                    ...
                    'password2', 'current_city','resume_title', 'resume_text'
                )
            }
        ),
    )
